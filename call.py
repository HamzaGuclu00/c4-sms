...
class SendCall():
    ...
    def CinselTerapi(self):
        try:
            ...
            if r.json()["message"] == 'Mesajın için teşekkürler. Gönderildi.':
                print(f"{Fore.LIGHTBLUE_EX}[+] {Style.RESET_ALL}Kabul Edildi ||| cinselterapi.info")
                self.adet += 1
            else:
                raise 
        except:
    ...
    def Otelz(self):
        try:
            ...
            if r.text == "true":
                print(f"{Fore.LIGHTBLUE_EX}[+] {Style.RESET_ALL}Kabul Edildi ||| otelz.com")
                self.adet += 1
            else:
                raise 
        except:
    ...
    def Vajini(self):
        try:
            ...
            if r.status_code == 303:
                print(f"{Fore.LIGHTBLUE_EX}[+] {Style.RESET_ALL}Kabul Edildi ||| vajinismustedavimerkezi.net")
                self.adet += 1
            else:
                raise 
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Reddedildi ||| vajinismustedavimerkezi.net")
    ...
    def GmcYatirim(self):
        try:
            ...
            r = requests.post(url, headers=headers, data=data, allow_redirects=False)
            if (r.status_code) == 302:
                print(f"{Fore.LIGHTBLUE_EX}[+] {Style.RESET_ALL}Kabul Edildi ||| gcmyatirim.com.tr")
                self.adet += 1
            else:
                raise 
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Reddedildi ||| gcmyatirim.com.tr")
